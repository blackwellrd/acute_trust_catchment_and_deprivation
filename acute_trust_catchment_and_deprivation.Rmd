...
map_RK9
ggsave('./output/maps/map_RK9_zoomed.png', map_RK9, height = 210, width = 297, units = 'mm')
```

### RA9	- Torbay And South Devon NHS Foundation Trust			
```{r catchment_RA9, echo = FALSE}
map_RA9 <- fnMap(
...
map_RA9
ggsave('./output/maps/map_RA9_zoomed.png', map_RA9, height = 210, width = 297, units = 'mm')
```

### RBZ	- Northern Devon Healthcare NHS Trust			
```{r catchment_RBZ, echo = FALSE}
map_RBZ <- fnMap(
...
map_RBZ
ggsave('./output/maps/map_RBZ_zoomed.png', map_RBZ, height = 210, width = 297, units = 'mm')
```

### RH8	- Royal Devon And Exeter NHS Foundation Trust			
```{r catchment_RH8, echo = FALSE}
map_RH8 <- fnMap(
...
map_RH8
ggsave('./output/maps/map_RH8_zoomed.png', map_RH8, height = 210, width = 297, units = 'mm')

```

### RH5	- Somerset NHS Foundation Trust
```{r catchment_RH5, echo = FALSE}
map_RH5 <- fnMap(
...
map_RH5
ggsave('./output/maps/map_RH5_zoomed.png', map_RH5, height = 210, width = 297, units = 'mm')
```

### RA4	- Yeovil District Hospital NHS Foundation Trust			
```{r catchment_RA4, echo = FALSE}
map_RA4 <- fnMap(
